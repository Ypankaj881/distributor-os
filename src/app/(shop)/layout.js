...
import CartIconLink from "@/components/shop/CartIconLink";
import CartBar from "@/components/shop/CartBar";
import { requireRetailerPage } from "@/server/auth/guards";
import { getCartQuantities } from "@/server/services/cartService";
...
export default async function ShopLayout({ children }) {
  ...
  const cartItems = await getCartQuantities(auth.companyId, auth.customerId);
